...
<%@ Register TagPrefix="whPlayer" TagName= "vaPlayer" Src="VideoPlayer.ascx" %>
 ...
 <table style="width: 100%; height: 100%">
		  ...
		  standby="Waiting..." id="NetOCX1"  name="ocx1" width="530" height="400" align="center" ></object>
                        ...
                        <div id="ControlPanel">
                        <div id="noRights" visible="false" runat="server" align="center" style="height:200px; vertical-align:middle; color:Red; font-size:15px;">您不是望远镜操作员，不能操作望远镜!</div>
                        <div id="hasRights" runat="server">
                            <table style="width: 100%; height: 100%; vertical-align: top">
                                ...
                                <td>赤经：</td>
                                <td></td>
                                <td><input type="text" id="txtRaH" style="width:100px" value="0"/></td>
                                <td style="width:5px">h</td>
                                <td><input type="text" id="txtRaM" style="width:100px" value="0"/></td>
                                <td style="width:5px">m</td>
                                <td><input type="text" id="txtRaS" style="width:100px" value="0"/></td>
                                <td style="width:5px">s</td>
                                </tr>
                                <tr>
                                <td>赤纬：</td>
                                <td>
                                ...
                                <td><input type="text" id="txtDecD" style="width:100px" value="0"/></td>
                                <td style="width:5px">°</td>
                                <td><input type="text" id="txtDecM" style="width:100px" value="0"/></td>
                                <td style="width:5px">′</td>
                                <td><input type="text" id="txtDecS" style="width:100px" value="0"/></td>
                                <td style="width:5px">″</td>
                                </tr>
                                <tr>
                                <td colspan="8">
                               <table width="100%">
                                ...
                                <button id="btnStopFindStar" type="button" class="sexybutton" style="width: 100px;" onmouseup="StopFindStar()">
