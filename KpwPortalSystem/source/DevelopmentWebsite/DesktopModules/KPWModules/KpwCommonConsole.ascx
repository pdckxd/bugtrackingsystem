<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KpwCommonConsole.ascx.cs" Inherits="DesktopModules.Web.KpwCommonConsole" %>
 ...
 <table style="width: 100%; height: 100%">
            <tr>
                <td>
		          ...
		          standby="Waiting..." id="NetOCX1"  name="ocx1" width="320" height="288" align="center" ></object>
                                            </td>
                                            </tr>
                                            <tr>
                                            <td align="left">
