...
{
    public partial class KpwCommonConsole : PortalModuleControl
    {
        private static ILog logger = log4net.LogManager.GetLogger(typeof(KpwCommonConsole));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.noRights.Visible = true;
                this.hasRights.Visible = false;
            }
        ...
        protected void lnkImage_Click(object sender, EventArgs e)
        {
            ...
            string filePath = Server.MapPath("astronomy/temp/" + fileName);//路径
