...
namespace Nairc.KPWPortal.DataLayer.DataObjects.Oracle
{
    /// <summary>
    /// Oracle specific factory that creates Sql Server specific data access objects.
    /// 
    /// GoF Design Pattern: Factory.
    /// </summary>
    internal class OracleDaoFactory : DaoFactory
    {
