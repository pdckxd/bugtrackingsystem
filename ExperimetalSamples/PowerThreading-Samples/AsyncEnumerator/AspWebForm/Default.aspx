<%@ Page Async="true" UICulture="auto" Culture="auto"
    Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" Debug ="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Async Web Form</title>
</head>
<body>
    ...
    <div>
        <table style="width: 371px">
            ...
            <tr>
                ...
                <td style="width: 182px">
                    <asp:Button ID="m_btnAPMGetImages" runat="server" Text="APM Get Images" Width="125px"
                        OnClick="m_btnAPMGetImages_Click" />
                </td>
            </tr>
        </table>
        <br />
